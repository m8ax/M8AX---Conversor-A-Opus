...
def convert_to_opus(file_path):
    ...
    if hacerv == "si":
        HacerVideo = [
            ...
            sample_rate,
            "-filter_complex",
            f"showwaves=s=1152x576:mode=cline[v];[0:a]anull[a];[v]drawtext=text='M8AX - {cleaned_text} - M8AX':fontfile='arial.ttf':fontcolor=white:fontsize=18:x=(w-text_w)/2:y=10[v]",  # Filtro Para Generar El Video De Ondas Y Añadir Texto
            "-map",
